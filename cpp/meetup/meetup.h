...
namespace meetup {
  class scheduler {
    ...
    int first_monday_of_month;
    int first_tuesday_of_month;
    int first_wednesday_of_month;
    int first_thursday_of_month;
    int first_friday_of_month;
    int first_saturday_of_month;
    int first_sunday_of_month;
