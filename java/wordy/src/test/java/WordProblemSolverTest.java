...
public class WordProblemSolverTest {
    ...
    public void testExponentiation2() {
        assertEquals(1000000000, solver.solve("What is 10 raised to the 9th power?"));
        // assertEquals(100000000, solver.solve("What is 10 raised to the 9th power?"));
    }

    // @Ignore("Remove to run test")
    @Test
    public void testExponentiation3() {
        assertEquals(33, solver.solve("What is 2 raised to the 5th power plus 1?"));
    }
